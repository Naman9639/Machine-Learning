...
training_set = train_datagen.flow_from_directory('Enter training directory',
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')

test_set = test_datagen.flow_from_directory('Enter test directory',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
img_pred = image.load_img('Path of the image for which you want to predict', target_size = (64, 64))
