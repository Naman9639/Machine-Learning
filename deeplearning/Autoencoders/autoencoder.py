...
BXI = glob(os.path.join("/home/shivank/Aligner/X", "*.png"))
# Address of the output training images
BYI = glob(os.path.join("/home/shivank/Aligner/Y", "*.png"))
batch_y = proc_images(BYI)

# Address of the test images
BTEST = glob(os.path.join("/home/shivank/Aligner/testcases", "*.png"))
